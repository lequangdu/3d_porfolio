  ...
  return (
    <section className="max-container">
      ...
      <div className="mt-5 flex flex-col gap-3 text-slate-500">
        <p>
          Frontend Engineer in Ho Chi Minh City, Vietnam. Working with ReactJS,
          NextJS, TailwindCSS, and other frontend technologies.
        </p>
      </div>
      ...
      <div className="py-16">
        ...
        <div className="mt-5 flex flex-col gap-3 to-slate-500">
          <p>
            I have worked with several companies and teams. I have also worked
